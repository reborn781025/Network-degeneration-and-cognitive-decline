...
for i=1:length(list)
    ...
    matlabbatch{1}.spm.tools.cat.tools.long.extopts.registration.darteltpm = {'/DARTEL/wTemplate_1.nii,1'}; % modify path accordingly
    matlabbatch{1}.spm.tools.cat.tools.long.extopts.registration.shootingtpm = {'/spm12/toolbox/cat12/templates_1.50mm/Template_0_IXI555_MNI152_GS.nii'}; % modify path accordingly
    ...
    matlabbatch{1}.spm.tools.cat.tools.long.warps = 1;
